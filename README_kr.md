...
[![Maven Central|154](https://img.shields.io/maven-central/v/io.github.gitfilo/chatmodel-audit-spring-boot-starter.svg)](https://central.sonatype.com/artifact/io.github.gitfilo/chatmodel-audit-spring-boot-starter)
...
전체 설정 키 목록은 [docs/configuration.md](docs/configuration.md)에 있습니다.
...
자세한 컴포넌트 다이어그램과 아키텍처 의사결정(ADR)은 [docs/architecture.md](docs/architecture.md)에 있습니다.
...
접근 제어는 Spring Security `ROLE_AUDIT_VIEWER`(읽기) / `ROLE_AUDIT_OWNER`(flag 등록)로 제한합니다. 자세한 명세는 `docs/13-dashboard-ui.md`.
